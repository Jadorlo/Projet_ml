...
def main2_one_var():
    ...
    model_name = f"test_preprocess2_Close_price_log_jaquart_dense64_dense2_WS{WINDOW_SIZE}"
    full_model_name = model_name+'-'+data_name+'-'+str(N_EPOCHS)
...
def main2_multivar():
    ...
    model_name = f"preprocess2_multi_var_log_price_jaquart_dense64_WS{WINDOW_SIZE}"
    full_model_name = model_name+'-'+data_name+'-'+str(N_EPOCHS)
